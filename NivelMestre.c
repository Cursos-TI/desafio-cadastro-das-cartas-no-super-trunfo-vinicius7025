 ...
 */
 ...
 int main(){
  ...
  // Coleta e armazena as informações da Carta 1
  ...
  // Coleta e armazena as informações da Carta 2
  ...
  // Calculando o "Super Poder" das cartas
     superpoder1 = ((float)populacao1 + area1 + pib1 + pturisticos1 + percapita1) + ( 1 / densidade1);
     superpoder2 = ((float)populacao2 + area2 + pib2 + pturisticos2 + percapita2) + ( 1 / densidade2);
